...
/** Class containing animations to show/hide views and start activities. */
public class AnimationUtils {
  ...
  public static Animation scaleUp(long duration, float from, float to) {
  ...
  public static Animation scaleDown(long duration, float from, float to) {
    Animation scaleDown = new ScaleAnimation(from, to, from, to, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    scaleDown.setDuration(duration);
    scaleDown.setInterpolator(new AccelerateInterpolator());
    return scaleDown;
  }
